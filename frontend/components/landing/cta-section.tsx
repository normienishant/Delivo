      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        >
          ...
          <div 
            ...
            style={{
              background: `radial-gradient(600px circle at ${mousePosition.x}% ${mousePosition.y}%, rgba(245,158,11,0.15), transparent 40%)`
            }}
          />
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
              ...
              <div className="flex-1">
                ...
                <p className="text-xl text-muted-foreground mb-12 leading-relaxed max-w-xl">
                  Plug Delivo into your stack in minutes. Run predictions locally, watch the live simulation, and let the AI agent rebalance your fleet automatically.
                </p>
